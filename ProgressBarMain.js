	...
	class Box extends HTMLElement {
		...
		render(val,valll ,valul, info, color) {
			...
			if(rounded >=0 && rounded <=100) {
				...
				this.$svg.innerHTML = '<path d="M 50 450 L950 550"></path><text class="percentage" text-anchor="middle" alignment-baseline="middle" x="500" y="200" font-size="140" font-weight="bold">' + rounded +'( '+percentage + '% )</text><text class="title" text-anchor="middle" alignment-baseline="middle" x="500" y="350" font-size="90" font-weight="normal">' + info + '</text><path d="' + z + '" class="data-progress"></path><text class="title" text-anchor="middle" alignment-baseline="middle" x="25" y="485" font-size="20" font-weight="normal">' + valll1 + '</text><text class="title" text-anchor="middle" alignment-baseline="middle" x="975" y="485" font-size="20" font-weight="normal">' + valul1 + '</text>"';
			}
		}
